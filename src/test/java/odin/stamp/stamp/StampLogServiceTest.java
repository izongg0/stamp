...
//            StampCollectDto dto = new StampCollectDto("01011111111");
//            StampCollectResDto stampCollectResDto = stampLogService.collect(dto,1L);
...
//        System.out.println(stampLogs.size());
//        assertEquals(2,stampLogs.size());
//        assertEquals(count,stampStatus.getAccumulatedStamp());
//
//        CouponUseReqDto couponUseReqDto = new CouponUseReqDto(storeCustomerId);
//        stampLogService.useCoupon(couponUseReqDto,1L);
//        CustomerStampStatusDto stampStatusFinal = customerService.getStampStatus(storeCustomerId);
//
//        assertEquals(2 ,stampStatusFinal.getTotalCoupon());
//
//    }
//
//
